...
class test_lfastfilter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Test Lfastfilter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Test Lfastfilter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_lfastfilter")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.lfast_MTFIRLowPassFilterXX_0 = lfast.MTFIRFilterCCF(1, firdes.low_pass(1, samp_rate, cutoff_freq, cutoff_freq*.2, window.WIN_HAMMING, 6.76), 4)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/opt/sdr/gnuradio/gnuradio_recordings/atsc/gnuradio_atsc_593MHz_6.2MSPS.raw', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(593e6, self.samp_rate)
...
def main(top_block_cls=test_lfastfilter, options=None):
